...
insert into `activity`(`name`, `startdate`, `starttime`, `length`, `capacity`, `approved`, `location`, `lat`, `lon`, `detail`) values
  ('Park paint', '2026-01-18', '19:00', '2:00', 20, 1, 'Pacific Spirit Park', 49.253270, -123.215703, 'Lorem ipsum.'),
  ('Park paint', '2026-01-25', '19:00', '2:00', 20, 0, 'Pacific Spirit Park', 49.253270, -123.215703, 'Lorem ipsum.');
